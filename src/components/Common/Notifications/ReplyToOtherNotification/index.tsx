...
type ReplyToOtherNotificationProps = {
  notification: Notification;
};
const ReplyToOtherNotification: FC<ReplyToOtherNotificationProps> = ({
  notification,
}) => {
      ...
      <Link
        to={
          notification.payload
            ? `/${notification.payload.username}/post/${notification.payload.postId}`
            : "#"
        }
        className={clsx(
...
export default ReplyToOtherNotification;
